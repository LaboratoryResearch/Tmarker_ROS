...
class KMWheels:
    ...
    def teleop_callback(self,data):
        ...
        new_right_velocity = linear_speed / D_RIGHT + angular_speed / (TREAD/D_RIGHT/2)  #右車輪の速度の更新
        new_left_velocity = linear_speed / D_LEFT - angular_speed / (TREAD/D_LEFT/2)    #左車輪の速度の更新
